            ...
            <div class="row clearfix">
                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                    <div class="image_block_1">
                        <div class="image-box">
                            <figure class="image image-1"><img src="assets/images/resource/about1.png" alt=""></figure>
                            ...
                            <div class="text">
                                <h4><i class="icon-donation"></i>NON à la violence basée sur le genre</h4>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                    <div class="content_block_1">
                        <div class="content-box">
                            <div class="inner">
                                <div class="sec-title">
                                    <span class="top-text">A propos de nous</span>
                                    <h2>Nous sommes l'oreille et la bouche des sans voies</h2>
                                </div>
                                <div class="text">
