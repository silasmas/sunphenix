            ...
            <div class="top-inner clearfix">
                ...
                <div class="right-column pull-right">
                    <div class="update-news">
                        <p><i class="icon-megaphone"></i><span>Updates:</span>
                          Pour toute violence faite contre le genre. . .</p>
                    </div>
    ...
    <div class="header-lower">
        <div class="outer-container">
            <div class="outer-box">
                ...
                <div class="nav-right-content clearfix search-box-btn">
...
<div class="mobile-menu">
    ...
    <nav class="menu-box">
        ...
        <div class="contact-info">
            <h4>Contact Info</h4>
            <ul>
                <li> 4652 AV COLONEL EBEYA KIN GOMBE RDC</li>
                <li><a href="tel:122">Appel : 122</a></li>
                <li><a href="mailto:info@example.com">contact@122.com</a></li>
            </ul>
        </div>
