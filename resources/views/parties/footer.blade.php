        ...
        <div class="inner-box clearfix">
            <div class="left-column pull-left">
                <div class="logo-box">
                    ...
                    <figure class="logo"><a href="#"><img src="assets/images/logo2.png" alt=""></a></figure>
                </div>
                <div class="text">
                    <h3><i class="icon-email-open-sketched-envelope"></i>Abonnez -vous à <br />notre newsletter</h3>
                </div>
            </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                    <div class="footer-widget about-widget">
                        <div class="title-box">
                            ...
                            <span>CALL 122</span>
                            <h3>Dénonçons les VBGs</h3>
                        </div>
                        <div class="text">
                            <p> Empêche que nous puissions faire ce que nous aimons le mieux, chaque plaisir est chaque douleur évitée.</p>
                            <a href="" class="theme-btn btn-one">Rejoignez-nous</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                    <div class="footer-widget contact-widget ml-30">
                        <div class="title-box">
                            ...
                            <span>122</span>
                            <h3>Rédonner l'espore</h3>
                        </div>
                        <div class="widget-content">
                            <div class="single-item">
                                <h3><a href="tel:23345678901">(+233) 456-789-01</a></h3>
                                <p><a href="mailto:example@info.com">info@122.com</a></p>
                            </div>
                            <div class="single-item">
                                <h5>Notre bureau</h5>
        ...
        <div class="auto-container">
            <div class="inner-box clearfix">
                <div class="copyright pull-left">
                    <p>&copy; 2022 <a href="">Call center 122,</a> All Rights Reserved.</p>
                </div>
                <ul class="footer-card pull-right clearfix">
                    <li><span>Moyen de faire un don:</span></li>
                    ...
                    <li><a href=""><img src="assets/images/resource/card-5.png" alt=""></a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="popup-inner">
        <div class="donate-content">
            <div class="sec-title centred">
                ...
                <h2>Créer un avenir meilleur</h2>
            </div>
                        ...
                        <div class="donate-box">
                            <div class="donate-option">
                                ...
                                <div class="other-amount">
                                    <div class="text">
                                        <h4>J'aime faire un don</h4>
                                        <p>Entrez votre montant personnalisé</p>
                                    </div>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 column">
                                    <div class="form-group message-btn">
                                        <button type="submit" class="theme-btn btn-one">Faire votre don maintenant</button>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 column">
                                    <div class="form-group">
                                        <label class="custom-control material-checkbox">
                                            ...
                                            <span class="description">Je souhaite faire un don répété automatiquement chaque mois</span>
                                        </label>
                                    </div>
                                </div>
                            </div>
